...
class entity(models.Model):
  ...
  total_amount = models.DecimalField(decimal_places=2, max_digits=55, default=0)
...
class individual_supporter_operation(models.Model):
  ...
  supporter_operation_id = models.ForeignKey(supporter_operation, on_delete=models.CASCADE)
